        ...
        <form id="multiStepForm" class="w-full rounded-sm shadow-lg overflow-hidden">
            ...
            <div class="overflow-x-auto scrollbar-hide px-4">
                ...
                <div id="stepIndicator"
                    ...
                    <!-- Step 1 -->
                    <div
                        class="step text-white px-4 py-2 rounded-xl space-x-3 min-w-[180px] h-full bg-green-600">
  ...
  <div class="bg-black/70 backdrop-blur-md text-white mx-auto rounded-xl p-6 shadow-lg  max-w-3xl addons-menu-css">
    ...
    <div class="space-y-4 text-sm">
      <div class="flex justify-between">
        ...
        <span class="text-white font-medium"><?= htmlspecialchars($payment_type ?? 'N/A') ?></span>
      </div>
      <div class="flex justify-between">
        <span class="text-gray-300">Email</span>
        <span class="text-white font-medium"><?= htmlspecialchars($email ?? 'N/A') ?></span>
      </div>
      <div class="flex justify-between">
        <span class="text-gray-300">Transaction id</span>
        <span class="text-white font-medium break-all"><?= htmlspecialchars($txn ?? 'N/A') ?></span>
      </div>
      <div class="border-t border-gray-600 pt-4 flex justify-between">
        <span class="text-gray-300">Amount Paid</span>
        <span class="text-white font-bold text-xl">$<?= number_format($amount ?? 0, 2) ?></span>
      </div>
    </div>
    ...
    <div class="mt-6 flex justify-center gap-4">
      <a href="https://calendly.com/digital-occamsadvisory/30min?month=2025-06" class="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-full text-sm font-semibold">
        Book a Call
      </a>
      <button href="https://digital.occamsadvisory.com" class="border border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white px-4 py-2 rounded-full text-sm font-semibold">
        Home
      </button>
    </div>
  </div>
