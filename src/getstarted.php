...
<script>
  function openFormPopup() {
    ...
    // Step 1: Instantly show popup without the widget script
    popupWrapper.innerHTML = `
    <div style="position: fixed; top: 0; left: 0; width: 100%; height: 100%;
                background: rgba(0,0,0,0.6); display: flex; align-items: center; justify-content: center;
                z-index: 9999;">
      <div style="background: white; padding: 20px; border-radius: 8px; max-width: 90vw; max-height: 90vh; overflow: auto; position: relative;">
        ...
        <div id="popup-content" style="text-align:center; padding:20px;">
          Loading...
        </div>
      </div>
    </div>
  `;
    ...
    // Step 2: After a small delay, inject the widget script (so it doesn’t block popup paint)
    setTimeout(() => {
      if (!document.getElementById('__v_snapshot_widget')) {
        const widgetScript = document.createElement('script');
        widgetScript.id = '__v_snapshot_widget';
        widgetScript.src = 'https://www.cdnstyles.com/static/snapshot_widget/v1/snapshot.widget.js';
        widgetScript.setAttribute('data', '');
